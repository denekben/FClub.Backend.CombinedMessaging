    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1db4505a-02f3-49a5-9837-aec1b0ecca44"), "Иван", "Иванович", "Иванов", false, new DateTime(2025, 4, 24, 19, 39, 9, 770, DateTimeKind.Utc).AddTicks(6810), "ivanov@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "+79991234567", null },
                    { new Guid("287bc96f-469a-4acb-9f83-ca0932c787e2"), "Петр", "Петрович", "Петров", false, new DateTime(2025, 4, 24, 19, 39, 9, 770, DateTimeKind.Utc).AddTicks(7283), "petrov@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "+79992345678", null },
                    { new Guid("3294e0e3-6409-431b-8ed2-db3819ebc635"), "Алексей", "Дмитриевич", "Смирнов", false, new DateTime(2025, 4, 24, 19, 39, 9, 770, DateTimeKind.Utc).AddTicks(7460), "smirnov@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "+79995678901", null },
                    { new Guid("754d703a-f1ea-425a-b3eb-b98829627774"), "Анна", "Сергеевна", "Сидорова", false, new DateTime(2025, 4, 24, 19, 39, 9, 770, DateTimeKind.Utc).AddTicks(7316), "sidorova@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "+79993456789", null },
                    { new Guid("a783ccef-eaf0-415d-b72a-6dffeeb247f5"), "Дмитрий", "Олегович", "Васильев", false, new DateTime(2025, 4, 24, 19, 39, 9, 770, DateTimeKind.Utc).AddTicks(7494), "vasilev@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "+79997890123", null },
                    { new Guid("d1cbac4f-29bb-46ad-a6dd-b987523de71a"), "Ольга", "Игоревна", "Новикова", false, new DateTime(2025, 4, 24, 19, 39, 9, 770, DateTimeKind.Utc).AddTicks(7509), "novikova@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "+79998901234", null },
                    { new Guid("d789e2e0-13d7-4fdb-9b38-2df0675525fc"), "Мария", "Алексеевна", "Кузнецова", false, new DateTime(2025, 4, 24, 19, 39, 9, 770, DateTimeKind.Utc).AddTicks(7440), "kuznetsova@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "+79994567890", null },
                    { new Guid("ed8a6578-96f3-4891-a816-ef0559b27ed3"), "Елена", "Викторовна", "Попова", false, new DateTime(2025, 4, 24, 19, 39, 9, 770, DateTimeKind.Utc).AddTicks(7478), "popova@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "+79996789012", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b7dfdb20-e6eb-401d-b6f5-aa9f9fb0b5d0"), true, "Вас давно с нами не было!", new Guid("1971ec6e-27c8-49fe-9339-bd6518ddb500"), 7L, 7L, "Мы расширяемся!", new Guid("3c5b7a46-c5b7-4694-9510-f6b4da2e0f07"), "У нас новинки!", new Guid("99026757-99ec-4735-aaf3-86259ab7b6ab") });
