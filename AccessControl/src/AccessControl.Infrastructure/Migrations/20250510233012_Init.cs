    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("097f561c-5ace-4e10-b5c6-53d1e3de4f03"), new DateTime(2025, 5, 10, 23, 30, 11, 513, DateTimeKind.Utc).AddTicks(445), 0L, 200L, "Филиал на Юго-Западной", null, "Москва", "Россия", "2к1", "ул. Покрышкина" },
                    { new Guid("0d4c30ca-4ad3-4881-971c-0855de9c63ed"), new DateTime(2025, 5, 10, 23, 30, 11, 513, DateTimeKind.Utc).AddTicks(669), 0L, 300L, "Филиал на Адмиралтейской", null, "Санкт-Петербург", "Россия", "11/2", "Невский пр." },
                    { new Guid("2a74ff8d-d12a-4dd7-9b2a-0ff744603b5b"), new DateTime(2025, 5, 10, 23, 30, 11, 513, DateTimeKind.Utc).AddTicks(649), 0L, 150L, "Филиал на Тверской", null, "Москва", "Россия", "17", "ул. Тверская" },
                    { new Guid("34a71229-c73a-44a3-ba97-a8f528a4b056"), new DateTime(2025, 5, 10, 23, 30, 11, 513, DateTimeKind.Utc).AddTicks(636), 0L, 150L, "Филиал на Воронцовской", null, "Москва", "Россия", "59", "ул. Профсоюзная" },
                    { new Guid("95a1368b-142b-455b-933c-3ac4f936de69"), new DateTime(2025, 5, 10, 23, 30, 11, 513, DateTimeKind.Utc).AddTicks(683), 0L, 100L, "Филиал на Плотинке", null, "Екатеринбург", "Россия", "32", "пр. Ленина" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1db4505a-02f3-49a5-9837-aec1b0ecca44"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(9036), "ivanov@example.com", false, "+79991234567", null, "Иван", "Иванович", "Иванов" },
                    { new Guid("287bc96f-469a-4acb-9f83-ca0932c787e2"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(9053), "petrov@example.com", false, "+79992345678", null, "Петр", "Петрович", "Петров" },
                    { new Guid("3294e0e3-6409-431b-8ed2-db3819ebc635"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(9210), "smirnov@example.com", false, "+79995678901", null, "Алексей", "Дмитриевич", "Смирнов" },
                    { new Guid("40416adb-dfe7-4533-ae73-80c7dd6f2e6e"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(8978), "ivanov@yandex.ru", true, "+78005553535", null, "Иванов", "Иванович", "Иван" },
                    { new Guid("58be07ff-8668-4d38-9c76-c0f3b805fe57"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(8675), "iolovich@yandex.ru", true, "+78005553535", null, "Евгения", "Алексеевна", "Иолович" },
                    { new Guid("6d9ffd62-5bd7-451e-a1f2-548ea313effb"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(9012), "petrov@yandex.ru", true, "+79991001010", null, "Петров", "Петрович", "Петр" },
                    { new Guid("754d703a-f1ea-425a-b3eb-b98829627774"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(9170), "sidorova@example.com", false, "+79993456789", null, "Анна", "Сергеевна", "Сидорова" },
                    { new Guid("a783ccef-eaf0-415d-b72a-6dffeeb247f5"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(9246), "vasilev@example.com", false, "+79997890123", null, "Дмитрий", "Олегович", "Васильев" },
                    { new Guid("d1cbac4f-29bb-46ad-a6dd-b987523de71a"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(9263), "novikova@example.com", false, "+79998901234", null, "Ольга", "Игоревна", "Новикова" },
                    { new Guid("d789e2e0-13d7-4fdb-9b38-2df0675525fc"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(9191), "kuznetsova@example.com", false, "+79994567890", null, "Мария", "Алексеевна", "Кузнецова" },
                    { new Guid("ed8a6578-96f3-4891-a816-ef0559b27ed3"), true, new DateTime(2025, 5, 10, 23, 30, 11, 518, DateTimeKind.Utc).AddTicks(9230), "popova@example.com", false, "+79996789012", null, "Елена", "Викторовна", "Попова" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("06fee5c7-0daf-4c8c-9271-4c14f26d5e2a"), new DateTime(2025, 5, 10, 23, 30, 11, 510, DateTimeKind.Utc).AddTicks(4233), "Фитнесс бар", null },
                    { new Guid("0c3ed5b6-9ea4-428b-8931-086a41951451"), new DateTime(2025, 5, 10, 23, 30, 11, 510, DateTimeKind.Utc).AddTicks(4229), "Кроссфит зона", null },
                    { new Guid("20b848e4-13fd-43d3-9452-763b6435e7c2"), new DateTime(2025, 5, 10, 23, 30, 11, 510, DateTimeKind.Utc).AddTicks(4231), "Боксерская зона", null },
                    { new Guid("23ad6d27-f2ea-4f57-a2e3-6a36e33fad69"), new DateTime(2025, 5, 10, 23, 30, 11, 510, DateTimeKind.Utc).AddTicks(4227), "Спа зона", null },
                    { new Guid("81c16014-83ce-4570-bd16-51e9ef4187b5"), new DateTime(2025, 5, 10, 23, 30, 11, 510, DateTimeKind.Utc).AddTicks(4222), "Хамам", null },
                    { new Guid("8d313217-d403-4368-8744-d44013db63ad"), new DateTime(2025, 5, 10, 23, 30, 11, 510, DateTimeKind.Utc).AddTicks(4225), "Бассейн", null },
                    { new Guid("f42cee3e-3e27-45e9-9a17-bb991a69f2ef"), new DateTime(2025, 5, 10, 23, 30, 11, 510, DateTimeKind.Utc).AddTicks(4053), "Тренажерный зал", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5973248c-c6b4-4858-8f96-3888db6340bd"), true, new DateTime(2025, 5, 10, 23, 30, 11, 514, DateTimeKind.Utc).AddTicks(7452), "Pro", null },
                    { new Guid("880c1cc1-e67a-4fc2-aa02-4066cb54f794"), true, new DateTime(2025, 5, 10, 23, 30, 11, 514, DateTimeKind.Utc).AddTicks(7450), "Standart", null },
                    { new Guid("c99c8b78-e28d-4696-87be-70e0e02716ba"), false, new DateTime(2025, 5, 10, 23, 30, 11, 514, DateTimeKind.Utc).AddTicks(7146), "Ligth", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("25825c4c-e04f-40c6-a00d-4a9dfbdbb91d"), new Guid("097f561c-5ace-4e10-b5c6-53d1e3de4f03"), new Guid("3294e0e3-6409-431b-8ed2-db3819ebc635"), new DateTime(2025, 5, 10, 23, 30, 11, 520, DateTimeKind.Utc).AddTicks(7180), new DateTime(2025, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("880c1cc1-e67a-4fc2-aa02-4066cb54f794"), null },
                    { new Guid("3a1d21d6-3bc4-4f26-ba7e-1ef9bb3b5286"), new Guid("2a74ff8d-d12a-4dd7-9b2a-0ff744603b5b"), new Guid("754d703a-f1ea-425a-b3eb-b98829627774"), new DateTime(2025, 5, 10, 23, 30, 11, 520, DateTimeKind.Utc).AddTicks(7173), new DateTime(2025, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("5973248c-c6b4-4858-8f96-3888db6340bd"), null },
                    { new Guid("53a621b5-fedc-4fc9-9232-6a62858d8e59"), new Guid("0d4c30ca-4ad3-4881-971c-0855de9c63ed"), new Guid("d1cbac4f-29bb-46ad-a6dd-b987523de71a"), new DateTime(2025, 5, 10, 23, 30, 11, 520, DateTimeKind.Utc).AddTicks(7189), new DateTime(2026, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("5973248c-c6b4-4858-8f96-3888db6340bd"), null },
                    { new Guid("7898f7a6-6f24-47e8-bf6d-7766e1638878"), new Guid("2a74ff8d-d12a-4dd7-9b2a-0ff744603b5b"), new Guid("a783ccef-eaf0-415d-b72a-6dffeeb247f5"), new DateTime(2025, 5, 10, 23, 30, 11, 520, DateTimeKind.Utc).AddTicks(7186), new DateTime(2026, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("880c1cc1-e67a-4fc2-aa02-4066cb54f794"), null },
                    { new Guid("82347d00-1363-4f40-99de-50b4096d44c8"), new Guid("097f561c-5ace-4e10-b5c6-53d1e3de4f03"), new Guid("1db4505a-02f3-49a5-9837-aec1b0ecca44"), new DateTime(2025, 5, 10, 23, 30, 11, 520, DateTimeKind.Utc).AddTicks(7041), new DateTime(2025, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("c99c8b78-e28d-4696-87be-70e0e02716ba"), null },
                    { new Guid("b661a029-3d11-43c2-a652-f233cdc7bc3e"), new Guid("0d4c30ca-4ad3-4881-971c-0855de9c63ed"), new Guid("d789e2e0-13d7-4fdb-9b38-2df0675525fc"), new DateTime(2025, 5, 10, 23, 30, 11, 520, DateTimeKind.Utc).AddTicks(7176), new DateTime(2025, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("c99c8b78-e28d-4696-87be-70e0e02716ba"), null },
                    { new Guid("b9e3f831-eb10-414b-93c1-b0888d970c9f"), new Guid("34a71229-c73a-44a3-ba97-a8f528a4b056"), new Guid("ed8a6578-96f3-4891-a816-ef0559b27ed3"), new DateTime(2025, 5, 10, 23, 30, 11, 520, DateTimeKind.Utc).AddTicks(7183), new DateTime(2025, 11, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("5973248c-c6b4-4858-8f96-3888db6340bd"), null },
                    { new Guid("f34285ab-2bfa-47a2-bda8-5ad707e24c8b"), new Guid("34a71229-c73a-44a3-ba97-a8f528a4b056"), new Guid("287bc96f-469a-4acb-9f83-ca0932c787e2"), new DateTime(2025, 5, 10, 23, 30, 11, 520, DateTimeKind.Utc).AddTicks(7168), new DateTime(2025, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("880c1cc1-e67a-4fc2-aa02-4066cb54f794"), null }
                });
