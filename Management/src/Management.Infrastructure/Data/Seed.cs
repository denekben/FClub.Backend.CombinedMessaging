...
namespace Management.Infrastructure.Data
{
    public class Seed
    {
        ...
        public List<AppUser> Admins { get; private set; } = [];
        public List<AppUser> Managers { get; private set; } = [];
        public List<DomainService> Services { get; private set; } = [];
        ...
        public List<SocialGroup> SocialGroups { get; private set; } = [];
        ...
        private void SeedUsers(ModelBuilder modelBuilder)
        {
            ...
            var manager2 = AppUser.Create(
                ...
                _passwordService.HashPassword("Petrov123!"),
                false, true,
                _tokenService.GenerateRefreshToken(),
                _tokenService.GenerateRefreshTokenExpiresDate(),
                ManagerRole.Id
        ...
        private void SeedServices(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DomainService>().HasData(Services);
        }
        ...
        private void SeedSocialGroups(ModelBuilder modelBuilder)
        {
            SocialGroups.AddRange([
                SocialGroup.Create(Guid.Parse("5514344f-43cf-407f-aa83-dc5b4b54c172"), "Студенты"),
                SocialGroup.Create(Guid.Parse("a2824bfb-2de7-44f2-a175-6ce1f440d5c9"), "Пенсионеры")
            ]);

            modelBuilder.Entity<SocialGroup>().HasData(SocialGroups);
        }
        ...
        private void SeedTariffs(ModelBuilder modelBuilder)
        {
            var tariff1 = Tariff.Create(
                ...
                {
                    {Guid.Parse("5514344f-43cf-407f-aa83-dc5b4b54c172"), 10},
                    {Guid.Parse("a2824bfb-2de7-44f2-a175-6ce1f440d5c9"), 25}
                },
                false
            );
        ...
        private void SeedClients(ModelBuilder modelBuilder)
        {
            ...
            var client5 = Client.Create(
                ...
                false, true, false, Guid.Parse("5514344f-43cf-407f-aa83-dc5b4b54c172"));
            ...
            var client7 = Client.Create(
                ...
                false, true, false, Guid.Parse("a2824bfb-2de7-44f2-a175-6ce1f440d5c9"));
